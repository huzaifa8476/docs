...
#### Setting attributes
 ...
 | Name | Details | 
 | --- | --- | 
 | CredentialsFilePath required | **Type** String **Description** Path of Google Workspace's JSON credentials file. [See Google's documentation to **create** these credentials](https://developers.google.com/workspace/guides/create-credentials?hl=en#see-googles-documentation-to-**create**-these-credentials). | 
